...
-(void)collapseOpenedSections
{
    for (NSNumber *section in [_showingSectionsDictionary allKeys])
    {
        [self collapseSection:section.integerValue animated:YES];
    }
}
